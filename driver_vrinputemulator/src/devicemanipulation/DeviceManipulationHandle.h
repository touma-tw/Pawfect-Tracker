...
private:
	...
	// NOTE: m_deviceTranslationOffset now holds an HMD-relative HEAD-LOCAL delta
	// (meters) precomputed by the client; handlePoseUpdate rotates it by the live
	// qDriverFromHeadRotation and adds it to vecDriverFromHeadTranslation.
